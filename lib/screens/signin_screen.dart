...
class LoginScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<LoginScreen> createState() => LoginPage();
}

class LoginPage extends ConsumerState<LoginScreen> {
  ...
  void onLogin(BuildContext context) {
    ...
    if (!email.endsWith('@gmail.com')) {
      _showAlert(context, 'Incorrect Email ID.');
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          ElevatedButton(
                            onPressed:
                                isLoading ? null : () => onLogin(context),
                            ...
                            child: isLoading ? Loader() : const Text('Sign In'),
                          ),
                          const SizedBox(height: 15.0),
                          Row(
